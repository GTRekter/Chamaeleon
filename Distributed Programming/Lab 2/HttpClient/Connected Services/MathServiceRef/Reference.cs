...
namespace HttpClient.MathServiceRef {
    ...
    public interface IMathService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/AddMultiple", ReplyAction="http://tempuri.org/IMathService/AddMultipleResponse")]
        double AddMultiple(double[] values);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/AddMultiple", ReplyAction="http://tempuri.org/IMathService/AddMultipleResponse")]
        System.Threading.Tasks.Task<double> AddMultipleAsync(double[] values);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/RectangleArea", ReplyAction="http://tempuri.org/IMathService/RectangleAreaResponse")]
        double RectangleArea(double width, double length);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/RectangleArea", ReplyAction="http://tempuri.org/IMathService/RectangleAreaResponse")]
        System.Threading.Tasks.Task<double> RectangleAreaAsync(double width, double length);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/TriangleArea", ReplyAction="http://tempuri.org/IMathService/TriangleAreaResponse")]
        double TriangleArea(double width, double height);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/TriangleArea", ReplyAction="http://tempuri.org/IMathService/TriangleAreaResponse")]
        System.Threading.Tasks.Task<double> TriangleAreaAsync(double width, double height);
    }
    ...
    public partial class MathServiceClient : System.ServiceModel.ClientBase<HttpClient.MathServiceRef.IMathService>, HttpClient.MathServiceRef.IMathService {
        ...
        public double AddMultiple(double[] values) {
            return base.Channel.AddMultiple(values);
        }
        
        public System.Threading.Tasks.Task<double> AddMultipleAsync(double[] values) {
            return base.Channel.AddMultipleAsync(values);
        }
        ...
        public double RectangleArea(double width, double length) {
            return base.Channel.RectangleArea(width, length);
        }
        
        public System.Threading.Tasks.Task<double> RectangleAreaAsync(double width, double length) {
            return base.Channel.RectangleAreaAsync(width, length);
        }
        
        public double TriangleArea(double width, double height) {
            return base.Channel.TriangleArea(width, height);
        }
        
        public System.Threading.Tasks.Task<double> TriangleAreaAsync(double width, double height) {
            return base.Channel.TriangleAreaAsync(width, height);
        }
    }
}
