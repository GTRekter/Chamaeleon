...
namespace Lab5Client
{
	public static class ClientHelper
	{
		...
		/// <returns></returns>
		private static HttpResults ParseResponse(HttpResponseMessage response)
		{
			HttpResults result = null;
			try
			{
				result = new HttpResults(response.StatusCode, response.ReasonPhrase);
			}
			catch (Exception ex)
			{
				System.Reflection.MethodBase mb = System.Reflection.MethodBase.GetCurrentMethod();
		...
		/// <param name="response">Response message object</param>
		/// <returns></returns>
		private static HttpResultsWithResponse<OutType> ParseResponse<OutType>(HttpResponseMessage response)
		{
			HttpResultsWithResponse<OutType> result = null;
			try
			{
                ...
                if (response.IsSuccessStatusCode)
                {
                    switch (serializationMode)
                    {
                        ...
                        case SerializationModesEnum.Xml:
                            ...
                            break;
						default:
							result = new HttpResultsWithResponse<OutType>(response.StatusCode, default(OutType)) { Error = "Unknown media content type" };
							break;
                    }
					if (serializer != null)
					{
						result = new HttpResultsWithResponse<OutType>(response.StatusCode, (OutType)serializer.ReadObject(stream));
					}
                }
                else
                {
                    switch (serializationMode)
                    {
                        ...
                        case SerializationModesEnum.Xml:
                            ...
                            break;
						default:
							result = new HttpResultsWithResponse<OutType>(response.StatusCode, default(OutType)) { Error = response.StatusCode.ToString() };
							break;
                    }
					if (serializer != null)
					{
						result = new HttpResultsWithResponse<OutType>(response.StatusCode, (string)serializer.ReadObject(stream));
					}
                }
#if DEBUG
        ...
        public static HttpResultsWithResponse<OutType> Get<OutType>(string service, SerializationModesEnum serializationMode, 
		...
		public static HttpResultsWithResponse<OutType> ExecuteHttpMethod<InType, OutType>(HttpMethod method, string service, SerializationModesEnum serializationMode, InType input, string uriFormat, params object[] values)
		{
			HttpResultsWithResponse<OutType> result = null;
			try
			{
		...
		/// <param name="values">Values used to create Uri parameters</param>
		/// <returns>Http results class object that contains either the result data or error</returns>
		public static HttpResults ExecuteHttpMethod<InType>(HttpMethod method, string service, SerializationModesEnum serializationMode, InType input, string uriFormat, params object[] values)
		{
			HttpResults result = null;
			try
			{
		...
		/// <param name="values">Values used to create Uri parameters</param>
		/// <returns>Http results class object that contains either the result data or error</returns>
		public static HttpResultsWithResponse<OutType> Post<InType, OutType>(string service, SerializationModesEnum serializationMode, InType input, string uriFormat, params object[] values)
		{
		...
		/// <param name="values">Values used to create Uri parameters</param>
		/// <returns>Http results class object that contains either the result data or error</returns>
		public static HttpResults Post<InType>(string service, SerializationModesEnum serializationMode, InType input, string uriFormat, params object[] values)
		{
			return ExecuteHttpMethod<InType>(HttpMethod.Post, service, serializationMode, input, uriFormat, values);
		}
		...
		/// <param name="values">Values used to create Uri parameters</param>
		/// <returns>Http results class object that contains either the result data or error</returns>
		public static HttpResultsWithResponse<OutType> Put<InType, OutType>(string service, SerializationModesEnum serializationMode, InType input, string uriFormat, params object[] values)
		{
		...
		/// <param name="values">Values used to create Uri parameters</param>
		/// <returns>Http results class object that contains either the result data or error</returns>
		public static HttpResults Put<InType>(string service, SerializationModesEnum serializationMode, InType input, string uriFormat, params object[] values)
		{
			return ExecuteHttpMethod<InType>(HttpMethod.Put, service, serializationMode, input, uriFormat, values);
		}
		...
		/// <param name="values">Values used to create Uri parameters</param>
		/// <returns>Http results class object that contains either the result data or error</returns>
		public static HttpResultsWithResponse<OutType> Delete<InType, OutType>(string service, SerializationModesEnum serializationMode, InType input, string uriFormat, params object[] values)
		{
		...
		/// <param name="values">Values used to create Uri parameters</param>
		/// <returns>Http result code - hopefully 200 (OK)</returns>
		public static HttpResults Delete(string service, string uriFormat, params object[] values)
		{
			HttpClient client = GetClient(service);
			HttpResults result = null;
			try
		...
		/// <param name="values">Values used to create Uri parameters</param>
		/// <returns>Http results class object that contains either the result data or error</returns>
		public static HttpResults Delete<InType>(string service, SerializationModesEnum serializationMode, InType input, string uriFormat, params object[] values)
		{
			return ExecuteHttpMethod<InType>(HttpMethod.Delete, service, serializationMode, input, uriFormat, values);
		}
		...
		/// <param name="values">Values used to create Uri parameters</param>
		/// <returns>Http result code - hopefully 200 (OK)</returns>
		public static HttpResultsWithResponse<object> Delete(string service, SerializationModesEnum serializationMode, string uriFormat, params object[] values)
		{
			HttpClient client = GetClient(service);
			HttpResultsWithResponse<object> result = null;
			try
			{
				HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Delete, string.Format(uriFormat, values));
				AddHeaders(request, serializationMode);
				using (HttpResponseMessage response = client.SendAsync(request).Result)
				{
					result = new HttpResultsWithResponse<object>(response.StatusCode, null);
					if (!response.IsSuccessStatusCode)
					{
						result.Error = response.StatusCode.ToString();
					}
