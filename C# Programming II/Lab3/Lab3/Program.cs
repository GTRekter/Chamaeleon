...
namespace Lab3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"a as degrees: {a}"); a = a.ToGradians();
            Console.WriteLine($"a as gradians: {a}"); a = a.ToRadians();
            Console.WriteLine($"a as radians: {a}"); a = a.ToTurns();
