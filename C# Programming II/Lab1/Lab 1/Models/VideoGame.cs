    ...
    class VideoGame : IMedia
    {
        ...
        public Soundtrack Soundtrack
        {
            ...
            set
            {
                if(null == value)
                {
                    throw new ArgumentException("Soundtrack cannot be null");
                }
                soundtrack = value;
            }
        }
        ...
        public VideoGame(int id, string title, string publisher, string creator, bool multiplayer, DateTime publishDate, Soundtrack soundtrack)
        {
            ID = id;
            Title = title;
            Publisher = publisher;
